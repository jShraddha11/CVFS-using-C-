...
void man(char *name)
{
    ...
    else if(strcmp(name,"read")==0)
    {
        ...
        printf("Usage:create File_name No_Of_Byts_To_Read\n");
    }
    ...
    {
        printf("Description:Used to display file\n");
...
void DisplayHelp()
{
    ...
    printf("fstat:To display information about of file using file descriptor\n");
...
void ls_file()
 {
    ...
    {
       printf("Error:Theree are no files\n");
       return;
    }

    printf("\n File Name\tInode number\tInodenumber\tFile size\tLink count\n");
    printf("---------------------------------------------\n");
    while(temp!=NULL)
    {
        if(temp!=NULL)
    ...
    while(1)
    {
        ...
        else if(count==2)
        {
           ...
           else if(strcmp(command[0],"rm")==0)
           {
              ...
              if(ret==-1)
              printf("Error:There is no such fie\n");
              continue;
           }
           ...
           else if(strcmp(command[0],"write")==0)
           {
            ...
            if(ret==-3)
            printf("ERROR:It is notregularfile\n");
}
